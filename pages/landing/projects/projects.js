...
export default function Sections({ screen, scroll }) {
    ...
    const styles = {
        ...
        btn_container: { background: "red", width: "250px", marginLeft: screen !== "mobile" ? "-25px" : 0, display: "flex", justifyContent: "center", alignItems: screen === "mobile" ? "start" : "center", top: screen === "mobile" ? "2vh" : 0, height: "150px", position: "relative", left: screen === "mobile" ? "50%" : "100px", transform: screen === "mobile" ? "translateX(-50%)" : "translateX((clamp(-100px, -10vw, -150px)))" },
